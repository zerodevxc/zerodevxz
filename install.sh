...
install_theme() {
  while true; do
    ...
    case "$SELECT_THEME" in
      1)
        THEME_URL=$(echo -e "https://github.com/zerodevxc/zerodevxz/raw/refs/heads/main/C2.zip")
        break
        ;;
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/zerodevxc/zerodevxz/raw/refs/heads/main/C3.zip")
        break
        ;; 
      x)
        return
...
while true; do
  ...
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : ZERO-HOSTING     ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : ZERO-HOSTING     ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by ZERO-HOSTING     ${NC}"
